...
const hero_data = {
  title_1: "Créatif",
  title_2: "Portfolio",
  des: `Bienvenue dans notre agence numérique ! Nous sommes spécialisés dans l'aide aux entreprises comme la vôtre pour réussir en ligne. De la conception de sites web au développement.`
}
