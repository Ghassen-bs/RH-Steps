          ...
          <div className="cs_contact_ms">
            <div className="cs_contact">
              <div className="cs_contact_text">
                ...
                <h3 className="cs_contact_title anim_text_writting">
                   Contactez-nous
                </h3>
              </div>
                ...
                <form onClick={e => e.preventDefault()}>
                  <div className="row">
                    <div className="cs_field_group col">
                      <input className="cs_input_field" type="text" id="test1" placeholder="Nom"
                        name="test" />
                      <label htmlFor="test1" className="cs_input_label">Nom</label>
                    </div>
                    <div className="cs_field_group col">
                      <input className="cs_input_field" type="text" id="test2" placeholder="Email"
                        name="test" />
                  ...
                  <div className="row">
                    <div className="cs_field_group col">
                      <input className="cs_input_field" type="text" id="test3" placeholder="Téléphone"
                        name="test" />
                      <label htmlFor="test3" className="cs_input_label">Téléphone</label>
                    </div>
                    <div className="cs_field_group col">
                      <input className="cs_input_field" type="text" id="test4" placeholder="Sujet"
                        name="test" />
                      <label htmlFor="test4" className="cs_input_label">Sujet</label>
                    </div>
                  </div>
            ...
            <div className="cs_contact_section_2 anim_div_ShowRightSide">
              <div className="cs_google_map cs_bg" data-src="assets/img/map_img.png">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d798.7165979935456!2d10.18010836910623!3d36.79775369072528!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12fd347299c32577%3A0xab2cfdf76ec95de8!2s14%20Rue%20de%20Greece%2C%20Tunis%2C%20Tunisie!5e0!3m2!1sfr!2seg!4v1748878671707!5m2!1sfr!2seg" 
                ...
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      <h6 className="cs_icon_title">Adresse</h6>
                      <p className="cs_icon_subtitle">14 rue de Grèce, Tunis, Tunisie</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    <a href="tel:26920940" className="cs_icon_style">
                      <i>
                    ...
                    <div className="cs_icon_text">
                      <h6 className="cs_icon_title">Téléphone</h6>
                      <p className="cs_icon_subtitle">26 920 940</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    <a href="mailto:rhsteps.production@gmail.com" className="cs_icon_style">
                      <i>
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">rhsteps.production@gmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
