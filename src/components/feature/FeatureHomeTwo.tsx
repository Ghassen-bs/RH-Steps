...
const feature_data: DataType = {
  ...
  title: `Élever Votre Entreprise au Niveau Supérieur Expertise en Services d'Agence de Démarrage`,
  des: `Bienvenue dans notre agence numérique ! Nous sommes spécialisés dans l'aide aux entreprises comme la vôtre pour réussir en ligne. De la conception et du développement de sites web au marketing numérique et à la publicité, nous avons les outils. De la conception et du développement de sites web au marketing numérique et à la publicité, nous avons les outils. De la conception et du développement de sites web. Bienvenue dans notre agence numérique.`,
  boxtitle: `Design Unique`,
  box_des_1: `Qualité Primée`,
  box_des_2: `Numérique du jour Excellence des applications mobiles`,
  features: [
    {
      id: 1,
      title: `Code Propre`,
      des_1: `Qualité Primée`,
      des_2: `Numérique du jour Excellence des applications mobiles`
    },
    {
      id: 2,
  ...
  // for home five 
  subtitle_2: `Pourquoi Nous Choisir`,
  title_2: `Maximiser Votre Présence en Ligne Maîtrise du Marketing Numérique`,
                ...
                <div className="anim_text">
                  ...
                  <div className="cs_service_back_btn">
                    <a href="#" className="cs_style_1 cs_color_1">
                      <span className="cs_font_18">En Savoir Plus</span> 
                      {' '}
