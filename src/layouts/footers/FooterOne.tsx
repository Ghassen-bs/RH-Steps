...
const footer_data: DataType = {
  email: `rhsteps.production@gmail.com`,
  phone: `26 920 940`,
  location: `14 rue de Grèce, Tunis, Tunisie`,
  footer_info: `Nous offrons des services créatifs et professionnels dans plusieurs domaines : photographie, vidéographie, montage vidéo, création de sites web, marketing digital et plus encore.`,
  links: [
    { title: `ACCUEIL`, link: "/" },
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5">
              ...
              <Image src={logoDark} alt="Logo" width={120} height={50} style={{ transform: 'scale(0.9) translateX(-20px)', transformOrigin: 'left center', objectFit: 'contain'}} />
