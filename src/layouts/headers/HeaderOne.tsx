...
import logoDark from "@/assets/img/logo_dark.jpg";
						...
						<div className="cs_main_header_in">
							<div className="cs_main_header_left">
								<Link className="cs_site_branding logo-dark" href="/">
									<Image src={logoImage} alt="Logo" width={150} height={50} style={{ transform: 'scale(3.2) translateX(-20px)', transformOrigin: 'left center', objectFit: 'contain', marginLeft: '-15px' }} />
								</Link>
			...
			<div className={`cs_side_header ${active ? "active" : ""}`}>
				...
				<div className="cs_side_header_in">
					<Link className="cs_site_branding" href="/">
						<Image src={logoDark} alt="Logo" width={150} height={50} style={{ transform: 'scale(2.2) translateX(-20px)', transformOrigin: 'left center', objectFit: 'contain', marginLeft: '-15px' }} />
					</Link>
							...
							<div className="cs_box_two">
								<div>
									<p>
										...
										<span className="ms-2">14 rue de Grèce, <br />
											&nbsp; &nbsp; &nbsp; &nbsp; Tunis, Tunisia</span>
									</p>
										...
										<a href="tel:26920940">
											<svg width="35" height="35" viewBox="0 0 18 19" fill="none"
												...
												<path
													...
													fill="white"></path>
											</svg><span className="ms-2">26 920 940</span></a>
									</h4>
									...
									<h4>
										<a href="mailto:rhsteps.production@gmail.com" className="cs_primary_font cs_text_btn" style={{ fontSize: '0.9em' }}><span
											className="cs_black">rhsteps.production@gmail.com</span></a>
									</h4>
								</div>
							</div>
						</div>
